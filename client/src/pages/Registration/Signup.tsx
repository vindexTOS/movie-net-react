...
const Signup = () => {
  const style = {
    ...
    inputDiv: `flex flex-col gap-2 bg-[#232323] w-[80%] h-[500px] rounded-[20px] items-center justify-center `,
    input: `h-[3.3rem] w-[22rem] shadow-inner py-2 bg-blue-300 flex items-center justify-between bg-[#ec2b58]  outline-none rounded-[30px] px-10`,
    icon: `text-white  text-[1.5rem]`,
    btn: `h-[3.3rem] w-[22rem] bg-[#ec2b58] rounded-[30px] text-white  text-[1.2rem]`,
  }
  return (
