...
const Filter = () => {
  ...
  const style = {
    section: `w-[90%] h-[120px] z-50 flex items-center justify-end gap-10 px-10 rounded-[10px] py-10 backdrop-blur-sm bg-white/10 `,
  }
  ...
  const sortBy = ['imDb', 'year', 'rottenTomatoes']
  return (
