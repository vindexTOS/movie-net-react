...
const ReviewCommentCard: FC<ReviewsPostType> = (data): JSX.Element => {
  const style = {
    mainDiv: `w-[100%] rounded-[12px] relative  max_smm:w-[100%] backdrop-blur-sm bg-white/10 boxshaddow flex items-start px-10 jusify-center gap-5 py-10 flex-col`,
    section: `w-[90%] flex items-center justify-between  bg-[#4df5cd]/50 px-10 rounded-[20px]  gap-2`,
    rateDiv: `flex items-center text-white  `,
    comment: `w-[100%] bg-[#f5cd4d]/50  p-10 rounded-[20px] text-white shadow-md`,
  }
